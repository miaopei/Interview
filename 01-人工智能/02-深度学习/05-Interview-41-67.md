...
* [41. 请简述应当从哪些方向上思考和解决深度学习中出现的的over fitting问题？](#41-请简述应当从哪些方向上思考和解决深度学习中出现的的over-fitting问题)
* [42. 神经网络中，是否隐藏层如果具有足够数量的单位，它就可以近似任何连续函数？](#42-神经网络中是否隐藏层如果具有足够数量的单位它就可以近似任何连续函数)
* [43. 为什么更深的网络更好？](#43-为什么更深的网络更好)
* [44. 更多的数据是否有利于更深的神经网络？](#44-更多的数据是否有利于更深的神经网络)
* [45. 不平衡数据是否会摧毁神经网络？](#45-不平衡数据是否会摧毁神经网络)
* [46. 你如何判断一个神经网络是记忆还是泛化?](#46-你如何判断一个神经网络是记忆还是泛化)
* [47. 无监督降维提供的是帮助还是摧毁？](#47-无监督降维提供的是帮助还是摧毁)
* [48. 是否可以将任何非线性作为激活函数?](#48-是否可以将任何非线性作为激活函数)
* [49. 批大小如何影响测试正确率？](#49-批大小如何影响测试正确率)
* [50. 损失函数重要吗？](#50-损失函数重要吗)
* [51. 初始化如何影响训练?](#51-初始化如何影响训练)
* [52. 不同层的权重是否以不同的速度收敛？](#52-不同层的权重是否以不同的速度收敛)
* [53. 正则化如何影响权重？](#53-正则化如何影响权重)
* [54. 什么是 fine-tuning？](#54-什么是-fine-tuning)
* [55. 请简单解释下目标检测中的这个IOU评价函数（intersection-over-union）](#55-请简单解释下目标检测中的这个iou评价函数intersection-over-union)
* [56. 什么是边框回归 Bounding-Box regression，以及为什么要做、怎么做](#56-什么是边框回归-bounding-box-regression以及为什么要做怎么做)
* [57. 请阐述下 Selective Search 的主要思想](#57-请阐述下-selective-search-的主要思想)
* [58. 什么是非极大值抑制（NMS）？](#58-什么是非极大值抑制nms)
* [59. 什么是深度学习中的 anchor（抛锚）？](#59-什么是深度学习中的-anchor抛锚)
* [60. CNN的特点以及优势](#60-cnn的特点以及优势)
* [61. 深度学习中有什么加快收敛/降低训练难度的方法？](#61-深度学习中有什么加快收敛降低训练难度的方法)
* [62. 请简单说下计算流图的前向和反向传播](#62-请简单说下计算流图的前向和反向传播)
* [63. 请写出链式法则并证明](#63-请写出链式法则并证明)
* [64. 请写出 Batch Normalization 的计算方法及其应用](#64-请写出-batch-normalization-的计算方法及其应用)
* [65. 神经网络中会用到批量梯度下降（BGD）吗？为什么用随机梯度下降（SGD）?](#65-神经网络中会用到批量梯度下降bgd吗为什么用随机梯度下降sgd)
* [66. 当神经网络的调参效果不好时，从哪些角度思考？（不要首先归结于 overfiting）](#66-当神经网络的调参效果不好时从哪些角度思考不要首先归结于-overfiting)
* [67. 请阐述下卷积神经网络CNN的基本原理](#67-请阐述下卷积神经网络cnn的基本原理)
