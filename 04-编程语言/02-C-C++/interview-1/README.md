...
> [C++ static 和const 的作用](https://www.jianshu.com/p/5c35cc218bb4)
...
>
> [C++ 智能指针](https://blog.csdn.net/a819825294/article/details/52139328)
>
...
>
> [C++ 高性能服务器网络框架设计细节](https://blog.csdn.net/wangzhen209/article/details/78249288)
>
> [epoll编程，如何实现高并发服务器开发？](https://www.zhihu.com/question/21516827/answer/53576754)
>
...
1. 设置触发条件，就是在你的函数中把你的回调函数名称转化为地址作为一个参数，以便于系统调用。
...
>
> [一文搞懂C语言回调函数](https://segmentfault.com/a/1190000008293902)
>
> [c语言实现回调函数](https://blog.csdn.net/socho/article/details/51583112)
>
...
- 这两个钩子是用来监控比较底层的硬件事件的，既然是记录和回放，所有的事件就当然都是有先后次序的。所以如果把回调函数放在DLL中，输入的事件被放在几个线程中记录，所以我们无法保证得到正确的次序。
